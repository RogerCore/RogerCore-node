...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `rogercore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ rogercore-node add wallet-service');
      console.log('    $ rogercore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ rogercore-node remove wallet-service');
      console.log('    $ rogercore-node remove insight-api');
      console.log();
    });
